...
#     Admin     #
#################
def test_loginNoAdmin(): #No admin access #cant login
    driver.get("http://localhost:8000/admin")
...
def test_loginNoAdmin(): #wrong password
    driver.get("http://localhost:8000/admin")
    assert "Django" in driver.title
...
def test_assertFailResultToaPassTestCase(): #assert No Result
    driver = webdriver.Chrome()
    driver.get("http://localhost:8000/admin/")
    assert "Django" in driver.title
...
test_assertFailResultToaPassTestCase()

def test_inputFalsePassword(): #assert No Result
    driver = webdriver.Chrome()
    driver.get("http://localhost:8000/admin/")
    assert "Django" in driver.title
...
test_inputFalsePassword()

    
#Add Category #given userabc1 superuser access to add category

def test_AddCategory(): #have admin access
    driver.get("http://localhost:8000/admin")
    assert "Django" in driver.title
...
def test_AddPost(): #have admin access
    driver.get("http://localhost:8000/admin")
    assert "Django" in driver.title
    ...
    addCategory = driver.find_element_by_name("title")
    addCategory.clear()
    ...
    select_box = Select(select_web_element)
